...
<h2>{"Congratulations, Exponential should now run on your system."|i18n("design/standard/setup/init")}</h2>
<p>
{"If you need help with Exponential, you can go to %ezlink and get help in the forums.
...
{"Click on the URL to access your new %ezlink or click the %donebutton button. Enjoy one of the most successful web content management systems!"
 |i18n("design/standard/setup/init",,
       hash('%ezlink',concat('<a href="',$site_info.url,'">',"Exponential website"|i18n("design/standard/setup/init"),'</a>'),
