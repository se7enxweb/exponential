...
<div class="draft-list">
    <div class="draft-list-head">
        <div class="draft-list-row">
            ...
            <div class="draft-list-cell">{'Version'|i18n( 'design/admin/content/edit_draft' )}</div>
            <div class="draft-list-cell">{'Translations'|i18n( 'design/admin/content/edit_draft' )}</div>
            <div class="draft-list-cell">{'Creator'|i18n( 'design/admin/content/edit_draft' )}</div>
            <div class="draft-list-cell">{'Created'|i18n( 'design/admin/content/edit_draft' )}</div>
            <div class="draft-list-cell">{'Modified'|i18n( 'design/admin/content/edit_draft' )}</div>
        </div>
    </div>
    <div class="draft-list-body">
        {section var=Drafts loop=$draft_versions sequence=array( bglight, bgdark )}
            <div class="{$Drafts.sequence} draft-list-row {if eq( $Drafts.item.id, $draft_checked )}active{/if}">
                {* Edit. *}
                ...
                {* Version/view. *}
                <div class="draft-list-cell">
                    <div class="draft-list-cell-inner">{'Version:'|i18n( 'design/admin/content/edit_draft' )}</div>
                ...
                {* Translation. *}
                <div class="draft-list-cell">
                    <div class="draft-list-cell-inner">{'Translations:'|i18n( 'design/admin/content/edit_draft' )}</div>
                ...
                {* Creator. *}
                <div class="draft-list-cell">
                    <div class="draft-list-cell-inner">{'Creator:'|i18n( 'design/admin/content/edit_draft' )}</div>
                    {$Drafts.item.creator.name|wash}
                </div>
                {* Created. *}
                <div class="draft-list-cell">
                    <div class="draft-list-cell-inner">{'Created:'|i18n( 'design/admin/content/edit_draft' )}</div>
                    {$Drafts.item.created|l10n( shortdatetime )}
                </div>
                {* Modified. *}
                <div class="draft-list-cell">
                    <div class="draft-list-cell-inner">{'Modified:'|i18n( 'design/admin/content/edit_draft' )}</div>
