...
{let page_limit=ezini( 'PaginationSettings', 'ItemsPerPage', 'admininterface.ini' )['package/list']|int()
     package_count=fetch( package, list_count, hash( repository_id, $repository_id ) )
...
{* Paged; the size is admininterface.ini [PaginationSettings]. The offset is
   already on the address as /offset/N, which the form action preserves. *}
{if $package_count|gt( $page_limit )}
<div class="context-toolbar">
{include name=PackageNavigator
         uri='design:navigator/google.tpl'
         page_uri='/package/list'
