...
class eZImageManagerTest extends ezpTestCase
{
    ...
    public function testMultiHandlerAlias()
    {
        ...
        // Code-coverage runs (xdebug) can be much slower; keep the guard but
        // allow enough headroom for the conversion to complete.
        set_time_limit( ini_get( 'max_execution_time' ) > 0 ? ini_get( 'max_execution_time' ) : 300 );
